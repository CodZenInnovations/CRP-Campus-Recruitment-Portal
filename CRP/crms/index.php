...
<head>
    <title>Campus Recruitment Portal|| Home Page</title>
                                                ...
                                                <div class="col-md-9 job-post-info text-left">
                                                    ...
                                                    <div class="job-single-sec">
                                                        ...
                                                        <ul class="job-list-info d-flex">
                                                            <li>
                                                                <i class="fas fa-users"></i> <?php echo $row['NoofOpenings']; ?>
                                                            </li>
                                                            <li>
                                                                <i class="fas fa-dollar-sign"></i> <?php echo $row['MonthlySalary']; ?>/Month
                                                            </li>
                                                            <li>
                                                                <i class="fas fa-map-marker-alt"></i><?php echo $row['JobLocation']; ?>
                                                            </li>
                                                ...
                                                <div class="col-md-9 job-post-info text-left">
                                                    ...
                                                    <div class="job-single-sec">
                                                        ...
                                                        <ul class="job-list-info d-flex">
                                                            ...
                                                            <li>
                                                                <i class="fas fa-calendar"></i> <?php echo $row['LastDate']; ?>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="clearfix"></div>
